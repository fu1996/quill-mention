    ...
    _createClass(Mention, [{
      ...
      value: function renderList(mentionChar, data, searchTerm) {
        if (data && data.length > 0) {
          ...
          // render tab menu
          var isTabMode = this.options.menuType === "tab";
          if (isTabMode) {
            ...
            var firstElement = this.mentionContainer.firstChild;
            // 如果第一个元素是div标签的话就先删除掉
            if (firstElement.id === this.options.tabContainerId) {
              this.mentionContainer.removeChild(firstElement);
            }
            var tabBox = this.options.renderTabMenu(this.mentionContainer, this.mentionList, data);
